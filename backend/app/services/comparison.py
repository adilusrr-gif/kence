...
class DocumentComparator:
    ...
    def compare_semantic(self, doc1_path: str, doc2_path: str) -> Dict:
        ...
        try:
            ...
            verdict = llm_service.simple_chat_guarded(verdict_prompt)
    ...
    def compare_technical_specs(self, doc1_path: str, doc2_path: str) -> Dict:
        ...
        from app.services.pipeline import stratified_sample
        spec1_raw = llm_service.simple_chat_guarded(extract_prompt.format(text=stratified_sample(text1, 20000, 8)))
        spec2_raw = llm_service.simple_chat_guarded(extract_prompt.format(text=stratified_sample(text2, 20000, 8)))
    ...
    def compare_thematic(self, doc1_path: str, doc2_path: str) -> Dict:
        ...
        try:
            ...
            synthesis = llm_service.simple_chat_guarded(synth_prompt)
        except Exception as e:
